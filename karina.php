...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="foto" src="karina.jpeg" alt="Karina">
            </div>
            <div class="col-md-8">

                <h4><b>KARINA SILVA DOS SANTOS CRUZ</b></h4>
                ...
                <ul>
                    ...
                    <li>FileMaker.</li>
                    <li>Back-End: Java, C, C#.</li>
                    <li>Front-End: HTML, CSS, JavaScript.</li>
                </ul>

                <strong>Cursos</strong>
                <ul>
                    <li>HTML & CSS - Alura.</li>
                    <li>Testes em Java - Alura.</li>
                    <li>Java - Alura.</li>
                </ul>

                <strong>Habilidades</strong>
                <ul>
                    <li>Proativa, organizada, comunicativa. </li>
                </ul>

                <strong>Intresses</strong>
                <ul>
                    <li>Ter dominio no mundo da tecnologia para trazer novas soluções para problemas diversos.</li>
                </ul>
