...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="foto" src="pedro_maia.jpeg" alt="Pedro Henrique Maia">
            </div>
            <div class="col-md-8">

                <h4><b>PEDRO HENRIQUE BERNARDO MAIA DA SILVA</b></h4>
                ...
                <ul>
                    ...
                    <li> Técnico em Máquinas.</li>
                    <li> Mestre em Design Think.</li>
                </ul>

                <strong>Cursos</strong>
                <ul>
                    <li> Inglês - Cultura inglesa.</li>
                    <li> Informatica - Saga.</li>
                </ul>
                ...
                <ul>
                    <li> Reconheciento internacional.</li>
                    <li> Prêmios para a empresa.</li>
                </ul>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <a href="https://instagram.com/_p_maia/" title="Instagram">
