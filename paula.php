...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="foto" src="paula.jpeg" alt="Paula">
            </div>
            <div class="col-md-8">

                <h4><b>PAULA FERNANDA SILVA COSTA</b></h4>
                ...
                <ul>
                    ...
                    <li>Programação em Java, C, C++, JavaScript e HTML.</li>
                </ul>

                <strong>Cursos</strong>
                <ul>
                    <li>Inglês - Cultura inglesa.</li>
                    <li>Programação Orientada a Objetos - Curso em Vídeo.</li>
                </ul>

                <strong>Habilidades</strong>
                <ul>
                    <li>Organização, comunicação e determinação. </li>
                </ul>

                <strong>Intresses</strong>
                <ul>
                    <li>Aprender, evoluir e acrescentar para a empresa.</li>
                </ul>

                <strong>Hobbies</strong>
                <ul>
                    <li>Passar o tempo cozinhando e assistindo séries.</li>
                </ul>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <a href="https://instagram.com/p_nanda13/" title="Instagram">
